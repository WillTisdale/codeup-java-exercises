...
//        System.out.println(Arrays.equals(words, words2));
        ...
        String[] phrases = {"are cool!", "scare me!", "look weird.", "smell bad..."};

        String[] twoBadgers = Arrays.copyOf(badgerArray, badgerArray.length);
        System.out.println(Arrays.toString(twoBadgers));

        for(var i = 0; i < twoBadgers.length; i++){
            twoBadgers[i] = twoBadgers[i] + " " + phrases[i];
        }
